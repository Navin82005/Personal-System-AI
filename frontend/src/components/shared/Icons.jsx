// SVG Icons for the UI — no external icon library needed

export const SparklesIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3l1.88 5.76a1 1 0 00.95.688h6.07l-4.91 3.57a1 1 0 00-.364 1.118l1.88 5.76-4.91-3.57a1 1 0 00-1.18 0l-4.91 3.57 1.88-5.76a1 1 0 00-.364-1.118L3.1 9.448h6.07a1 1 0 00.95-.688L12 3z" />
  </svg>
);
...
export const BrainIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.5 2A2.5 2.5 0 0112 4.5v15a2.5 2.5 0 01-4.96-.46 2.5 2.5 0 01-1.07-4.74 3 3 0 01-.34-5.58 2.5 2.5 0 011.87-3.72" />
    <path d="M14.5 2A2.5 2.5 0 0112 4.5v15a2.5 2.5 0 004.96-.46 2.5 2.5 0 001.07-4.74 3 3 0 00.34-5.58 2.5 2.5 0 00-1.87-3.72" />
  </svg>
);

export const InsightsIcon = ({ size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
